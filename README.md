...
- Developed first draft of our visualization and included the file on the main branch.  Link is [here](https://public.tableau.com/app/profile/tonjakae/viz/VandyDataViz-FinalProject/PropertyLocationMap?publish=yes) as well.
